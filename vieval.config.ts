...
const localModel = {
  id: 'local', aliases: ['candidate'], model: 'local',
  inferenceExecutor: 'local', inferenceExecutorId: 'local',
}
...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      plugins: env.OPENAI_API_KEY && env.EVAL_MODEL ? [ChatModels({
        models: [chatModelFrom({
          aliases: ['candidate'],
